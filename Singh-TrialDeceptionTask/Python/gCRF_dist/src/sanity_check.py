...
test_filename = '../hide_texts/wsj_0607.out'
...
def check_CRFSuite():
    ...
    for (model_name, model_type, model_path, model_file) in [('segmentation', 'segmenter', paths.SEGMENTER_MODEL_PATH, 'seg.crfsuite'),
        ...
        try:
            print '*** Loading classifier %s at %s%s...' % (model_name, model_path, model_file)
