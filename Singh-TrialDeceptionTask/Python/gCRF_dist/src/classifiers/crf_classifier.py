...
#        print self.classifier_cmd
        self.classifier = subprocess.Popen(self.classifier_cmd, shell = True, stdin = subprocess.PIPE, stdout = subprocess.PIPE, universal_newlines=True)
...
#         lines = []
#         line = self.classifier.stdout.readline()
#         while (line.strip() != ''):
# #            print line
#             lines.append(line)
#             line = self.classifier.stdout.readline()
...
#             raise OSError('crf_classifier subprocess died')
        ...
        out, err = self.classifier.communicate()
        self.start()
        lines = []
